    ...
    <div className="min-h-screen w-full flex items-center justify-center p-6 overflow-auto"
      ...
      <div className="bg-white w-full max-w-md rounded-2xl p-10"
          ...
          <div className="flex gap-2">
            {["user", "owner", "deliveryBoy"].map((r) => (
              <button
                ...
                style={
                  role === r
                    ? { backgroundColor: "#FF4D2D", color: "white", border: "1.5px solid #FF4D2D" }
                    : { backgroundColor: "#FAFAFA", color: "#aaa", border: "1.5px solid #EAEAEA" }
                }
              >
                {ROLE_LABELS[r]}
              </button>
        ...
        <button
          ...
          onMouseEnter={e => { if (!loading) e.target.style.backgroundColor = "#E64323" }}
          onMouseLeave={e => { if (!loading) e.target.style.backgroundColor = "#FF4D2D" }}
        >
          {loading && (
